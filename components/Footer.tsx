...
function Footer() {
    return (
        <section className="py-7 space-y-6 px-4">
            <div className="flex flex-col items-center justify-center text-center space-y-5">
                <div className="w-36 h-8 relative">
                    <Image src={"/icons/logo-long.svg"} layout="fill" alt="... logo" objectFit="contain"/>
                </div>
            ...
            <div>
                <div className="flex flex-row items-center justify-center space-x-6 text-sm py-5">
                    <a href="#">Terms of Services</a> <span>•</span>{" "}
                ...
                <div className="space-y-4">
                    <p className="text-xs text-center">
                        2024 QuickTailor. All right reserved.
                    </p>
